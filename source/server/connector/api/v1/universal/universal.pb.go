...
type Group struct {
	...
	GroupLeaderId int64  `protobuf:"varint,5,opt,name=group_leader_id,json=groupLeaderId,proto3" json:"group_leader_id,omitempty"`
...
func (x *Group) Reset() {
	*x = Group{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v1_universal_universal_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Group) Descriptor() ([]byte, []int) {
	return file_v1_universal_universal_proto_rawDescGZIP(), []int{4}
}
...
func (x *Group) GetGroupDesc() string {
	if x != nil {
		return x.GroupDesc
	}
	return ""
...
func (x *Group) GetGroupLeaderId() int64 {
	if x != nil {
...
type GroupMember struct {
	...
	MemberNoteName string `protobuf:"bytes,3,opt,name=member_note_name,json=memberNoteName,proto3" json:"member_note_name,omitempty"` //申请为群成员时，不填写群昵称的话，默认就是用户的昵称
	MemberAvatar   string `protobuf:"bytes,4,opt,name=member_avatar,json=memberAvatar,proto3" json:"member_avatar,omitempty"`
	JoinAt         string `protobuf:"bytes,5,opt,name=join_at,json=joinAt,proto3" json:"join_at,omitempty"`
	MemberRole     string `protobuf:"bytes,6,opt,name=member_role,json=memberRole,proto3" json:"member_role,omitempty"` //群主，管理员，普通成员
}

func (x *GroupMember) Reset() {
	*x = GroupMember{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v1_universal_universal_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GroupMember) Descriptor() ([]byte, []int) {
	return file_v1_universal_universal_proto_rawDescGZIP(), []int{5}
}
...
func (x *GroupMember) GetMemberId() int64 {
	if x != nil {
		return x.MemberId
	}
	return 0
...
func (x *GroupMember) GetMemberNoteName() string {
	if x != nil {
...
func (x *GroupMember) GetMemberAvatar() string {
	if x != nil {
...
func (x *GroupRequest) Reset() {
	*x = GroupRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v1_universal_universal_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GroupRequest) Descriptor() ([]byte, []int) {
	return file_v1_universal_universal_proto_rawDescGZIP(), []int{6}
}

func (x *GroupRequest) GetRequestId() int64 {
	if x != nil {
		return x.RequestId
	}
	return 0
...
func (x *GroupRequest) GetRequesterId() int64 {
	if x != nil {
		return x.RequesterId
	}
	return 0
...
func (x *GroupRequest) GetDesc() string {
	if x != nil {
		return x.Desc
	}
	return ""
...
func (x *GroupRequest) GetCreateAt() string {
	if x != nil {
		return x.CreateAt
	}
	return ""
...
func (x *GroupRequest) GetUpdateAt() string {
	if x != nil {
		return x.UpdateAt
	}
	return ""
...
var file_v1_universal_universal_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x72, 0x65, 0x61, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xc8, 0x01, 0x0a, 0x05,
	...
	,
	...
	0x0a, 0x10, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x6e, 0x6f, 0x74, 0x65, 0x5f, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x4e, 0x6f, 0x74, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x6d, 0x65, 0x6d, 0x62,
	...
	0x07, 0x6a, 0x6f, 0x69, 0x6e, 0x5f, 0x61, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x6a, 0x6f, 0x69, 0x6e, 0x41, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6d, 0x65, 0x6d,
	0x62, 0x65, 0x72, 0x52, 0x6f, 0x6c, 0x65, 0x22, 0x86, 0x02, 0x0a, 0x0c, 0x47, 0x72, 0x6f, 0x75,
	...
	0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x65, 0x73, 0x63, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x65, 0x73, 0x63, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x61, 0x74, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x74, 0x12, 0x1b,
	0x0a, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x61, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x6e,
	...
	0x42, 0x26, 0x5a, 0x24, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2f, 0x61, 0x70,
	0x69, 0x2f, 0x76, 0x31, 0x2f, 0x75, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x61, 0x6c, 0x3b, 0x75,
	0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x61, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_v1_universal_universal_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_v1_universal_universal_proto_goTypes = []interface{}{
	...
	(*Group)(nil),             // 4: api.v1.universal.Group
	(*GroupMember)(nil),       // 5: api.v1.universal.GroupMember
	(*GroupRequest)(nil),      // 6: api.v1.universal.GroupRequest
}
...
func file_v1_universal_universal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_universal_universal_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Group); i {
			case 0:
				return &v.state
			case 1:
		...
		file_v1_universal_universal_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_universal_universal_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
