...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd4, 0x02,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0x85, 0x01,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Aliyun)(nil),              // 3: kratos.api.Aliyun
	(*Sts)(nil),                 // 4: kratos.api.Sts
	(*Sms)(nil),                 // 5: kratos.api.Sms
	(*Oss)(nil),                 // 6: kratos.api.Oss
	(*Etcd)(nil),                // 7: kratos.api.Etcd
	(*Discovery)(nil),           // 8: kratos.api.Discovery
	(*Registry)(nil),            // 9: kratos.api.Registry
	(*HTTP)(nil),                // 10: kratos.api.HTTP
	(*GRPC)(nil),                // 11: kratos.api.GRPC
	(*Server)(nil),              // 12: kratos.api.Server
	(*Data)(nil),                // 13: kratos.api.Data
	(*Data_Database)(nil),       // 14: kratos.api.Data.Database
	(*Data_Redis)(nil),          // 15: kratos.api.Data.Redis
	(*durationpb.Duration)(nil), // 16: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	12, // 0: kratos.api.Bootstrap.server:type_name -> kratos.api.Server
	13, // 1: kratos.api.Bootstrap.data:type_name -> kratos.api.Data
	8,  // 2: kratos.api.Bootstrap.discovery:type_name -> kratos.api.Discovery
	9,  // 3: kratos.api.Bootstrap.registry:type_name -> kratos.api.Registry
	2,  // 4: kratos.api.Bootstrap.service:type_name -> kratos.api.Service
	3,  // 5: kratos.api.Bootstrap.aliyun:type_name -> kratos.api.Aliyun
	1,  // 6: kratos.api.Bootstrap.snowflake:type_name -> kratos.api.Snowflake
	5,  // 7: kratos.api.Aliyun.sms:type_name -> kratos.api.Sms
	6,  // 8: kratos.api.Aliyun.oss:type_name -> kratos.api.Oss
	4,  // 9: kratos.api.Aliyun.sts:type_name -> kratos.api.Sts
	7,  // 10: kratos.api.Discovery.etcd:type_name -> kratos.api.Etcd
	7,  // 11: kratos.api.Registry.etcd:type_name -> kratos.api.Etcd
	16, // 12: kratos.api.HTTP.timeout:type_name -> google.protobuf.Duration
	16, // 13: kratos.api.GRPC.timeout:type_name -> google.protobuf.Duration
	10, // 14: kratos.api.Server.http:type_name -> kratos.api.HTTP
	11, // 15: kratos.api.Server.grpc:type_name -> kratos.api.GRPC
	14, // 16: kratos.api.Data.database:type_name -> kratos.api.Data.Database
	15, // 17: kratos.api.Data.redis:type_name -> kratos.api.Data.Redis
